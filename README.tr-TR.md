...
| `<konu> için skill var mı?` / `Is there a skill for <topic>?` | Paketlenmiş `rad-skill-finder`, yerel → `npx skills` ekosistemi → dizinler → web sırasıyla arar; onayınız olmadan hiçbir şey kurmaz. |
